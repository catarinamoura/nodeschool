...
// ## Boilerplate
    ...
    function reduce(arr, fn, initial) {
      return (function reduceOnebyOne(index,value){
       
        if( index < arr.length){
          return reduceOnebyOne(index+1, fn(value,arr[index],index,arr));
        }
        else{
          // Stop condition: Already went through all the array values 
          return value;
        }
